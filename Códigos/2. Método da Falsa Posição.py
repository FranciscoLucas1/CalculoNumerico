...
def instrucoes():
    i = (
        ...
        "Este programa permite calcular raízes de funções usando o método da falsa posição.\n"
        "Você pode escolher entre diferentes funções matemáticas, como seno, cosseno, tangente, logaritmo etc.\n"
        "Digite a função desejada, os valores de 'a' e 'b' do intervalo, e a precisão desejada (em notação científica ou formato decimal).\n"
    ...
    match opcao:
        case '1':
            ...
            if Fa * Fb > 0.0:
                ...
                while math.fabs(func(xi, f)) > p:
                    
                    xi = (a*func(b, f)- b*func(a, f))/(func(b, f) - func(a, f))
                    f_xi = func(xi, f)

                    if func(a, f) * f_xi < 0:
                        b = xi
                    elif func(a, f) * f_xi > 0:
                        a = xi
